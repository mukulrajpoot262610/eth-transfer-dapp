...
const Profile = ({ defaultAccount, userBalance, errorMessage, connectWalletHandler, connButtonText }) => {
    return (
        <div className='card bg-base-200 p-8 shadow-xl mr-4 w-full'>
            <div className="grid flex-grow card place-items-center">
                ...
                <div className="shadow-2xl stats">
                    <div className="stat">
                        ...
                        <div className="stat-value text-warning text-base"> {defaultAccount}</div>
                ...
                <div className="shadow-2xl stats my-4">
                    <div className="stat">
                        ...
                        <div className="stat-value text-warning"> {userBalance ? userBalance : 0.0} <span className='text-base'>ETH</span></div>
                        <div className="stat-desc">Ropsten Test Network</div>
                    </div>
                </div>
